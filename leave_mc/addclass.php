	...
	<div class="header">
			...
			<h2>CAMPUS </h2>
				...
				<div class="right-inside">
					<center>
				<div class="heading"><h3>ADD CLASS</h3></div>
...
if(isset($_POST['submit'])){
    ...
    if(mysqli_query($conn,"insert into `class` values(null,$year,'$branch','$section')")){
        echo "<script>alert('Class Add Successfully');</script>";
    }else{
        echo "<script>alert('Error while Adding the class');</script>";
    }
}
?>